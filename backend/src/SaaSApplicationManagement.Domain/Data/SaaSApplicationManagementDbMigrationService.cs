...
{
    public class SaaSApplicationManagementDbMigrationService : ITransientDependency
    {
        public ILogger<SaaSApplicationManagementDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<ISaaSApplicationManagementDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public SaaSApplicationManagementDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<ISaaSApplicationManagementDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<SaaSApplicationManagementDbMigrationService>.Instance;
        }
