...
namespace SaaSApplicationManagement.Users
{
    ...
    public class EnterpriseUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SaaSApplicationManagementDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SaaSApplicationManagementEfCoreEntityExtensionMappings to extend the IdentityUser entity
