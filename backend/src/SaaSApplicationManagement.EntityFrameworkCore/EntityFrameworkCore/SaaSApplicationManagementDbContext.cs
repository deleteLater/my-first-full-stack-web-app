...
namespace SaaSApplicationManagement.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See SaaSApplicationManagementMigrationsDbContext for migrations.
     */
    ...
    public class SaaSApplicationManagementDbContext : AbpDbContext<SaaSApplicationManagementDbContext>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<EnterpriseUser>(b =>
            {
                 ...
                 * Also see the SaaSApplicationManagementEfCoreEntityExtensionMappings class
                 */
            });
